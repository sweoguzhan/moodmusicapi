...
declare const CreateInferenceRecommendationsJobCommand_base: {
    new (input: CreateInferenceRecommendationsJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInferenceRecommendationsJobCommandInput, CreateInferenceRecommendationsJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateInferenceRecommendationsJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInferenceRecommendationsJobCommandInput, CreateInferenceRecommendationsJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
