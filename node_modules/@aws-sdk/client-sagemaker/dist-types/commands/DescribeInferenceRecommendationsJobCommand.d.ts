...
import { DescribeInferenceRecommendationsJobRequest, DescribeInferenceRecommendationsJobResponse } from "../models/models_3";
...
declare const DescribeInferenceRecommendationsJobCommand_base: {
    new (input: DescribeInferenceRecommendationsJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeInferenceRecommendationsJobCommandInput, DescribeInferenceRecommendationsJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeInferenceRecommendationsJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeInferenceRecommendationsJobCommandInput, DescribeInferenceRecommendationsJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
